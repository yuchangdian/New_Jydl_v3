...
declare class Driver {
    ...
    * @returns { Promise<void> }
     ...
     * @param { number } d - The number of cells for two fingers scroll on the touchpad.
     *                    Each cell will make the target point shift 120 pixels.
     * @param { number } [speed] - The Speed of touchpad two fingers scroll(cells per second), ranges from 1 to 500.
     ...
     * @param { number } times - The times of knuckle knock. The value ranges from 1 to 2,
     ...
     * @param { number } [speed] - The speed of swipe (pixels per second), ranges from 200 to 40000.
...
export { Component, Driver, UiWindow, ON, On, MatchPattern, DisplayRotation, ResizeDirection, WindowMode, Point, WindowFilter, Rect, PointerMatrix, UiDirection, MouseButton, UIElementInfo, UIEventObserver, TouchPadSwipeOptions, InputTextMode, WindowChangeType, ComponentEventType, WindowChangeOptions, ComponentEventOptions };
