// 根据 Qt setting.h 移植；字段顺序与类型保持原样。
#pragma once
#include <cstdint>
...
#pragma pack(push, 1)
struct CommonSetting_PrimarySystem_Struct {
    uint32_t SystemGroundingMode;	// 系统中性点接地方式：(1)——小电阻接地方式
    //										 (2)——消弧线圈接地方式
    //									   (3)——小电阻并消弧线圈接地方式
    float RatedCurrent_Primary;	    // 一次电流额定值：****A
    float PTp_Primary;		// 母线相PT一次值：***.*kV
    float PTp_Secondary;	// 母线相PT二次值：****V
    float PTo_Primary;		// 母线零序PT一次值：***.*kV
    float PTo_Secondary;	// 母线零序PT二次值：****V
    float CTp_Primary;		// 保护CT一次值：****A
    float CTp_Secondary;	// 保护CT二次值：****A
    float CTo_Primary;		// 零序CT一次值：****A
    float CTo_Secondary;	// 零序CT二次值：****A
    uint32_t	CRC;	//校验码
};

struct CommonSetting_PTCT_Ratio_Struct {
    float PTp_Bus;
    float PTo_Bus;
    float PT_Line;
...
struct CommonSetting_AnalogQuantity_Parameter_Struct {
    float Ua, Ub, Uc, Uo;
    float IA, IB, IC, Io;
};

struct CommonSetting_AnalogQuantity_Struct {
...
struct CommonSetting_TeleMeasuring_Struct {
...
struct CommonSetting_TeleSignaling_Struct {
...
struct CommonSetting_TeleControlling_Struct {
...
struct CommonSetting_ExceedingLimit_Struct {
    uint32_t Enable_LineVoltageExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_LineVoltageExceedingUpperLimit;     // ***.**V
    uint32_t Enable_LineVoltageExceedingLowerLimit; // Yes(1)-/No(0)-
    float Value_LineVoltageExceedingLowerLimit;     // ***.**V
    uint32_t Enable_FrequencyExceedingLimit; // Yes(1)-/No(0)-
    float Value_FrequencyUpperLimit;         // **.***Hz
    float Value_FrequencyLowerLimit;         // **.***Hz
    uint32_t Enable_ZeroSequenceVoltageExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_ZeroSequenceVoltageExceedingUpperLimit;     // ***.**V
    uint32_t Enable_VoltageImbalanceRateExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_VoltageImbalanceRateExceedingUpperLimit;     // ***.**%
    uint32_t Enable_VoltageHarmonicExceedingLimit; // Yes(1)-/No(0)-
    float Value_VoltageTotalHarmonicLimit;         // **.***%
    uint32_t Enable_PhaseCurrentExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_PhaseCurrentExceedingUpperLimit;     // ***.**A
    uint32_t Enable_ZeroSequenceCurrentExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_ZeroSequenceCurrentExceedingUpperLimit;     // ***.**A
    uint32_t Enable_CurrentImbalanceRateExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_CurrentImbalanceRateExceedingUpperLimit;     // ***.**%
    uint32_t Enable_PhaseDifferentialCurrentExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_PhaseDifferentialCurrentExceedingUpperLimit;     // ***.**A
    uint32_t Enable_ZeroSequenceDifferentialCurrentExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_ZeroSequenceDifferentialCurrentExceedingUpperLimit;     // ***.**A
    uint32_t Enable_CurrentHarmonicExceedingLimit; // Yes(1)-/No(0)-
    float Value_CurrentTotalHarmonicLimit;         // **.***%
    uint32_t Enable_LoadRateExceedingUpperLimit; // Yes(1)-/No(0)-
    float Value_LoadRateRateExceedingUpperLimit; // ***.**%
    uint32_t Time_Delay; // ***.**s
    uint32_t CRC; //
};

struct CommonSetting_Statistics_Struct {
...
struct ProtectionSoftStrap_Struct {
...
struct RelaySetting_Common_Struct {
...
struct RelaySetting_Communication_Struct {
...
struct RelaySetting_PilotRelay_Common_Struct {
...
struct RelaySetting_PilotRelay_StartElement_Struct {
...
struct RelaySetting_PilotRelay_Current_Struct {
...
struct RelaySetting_PilotRelay_Io_Struct {
...
struct RelaySetting_PilotRelay_Struct {
...
struct RelaySetting_OverCurrentRelay_VoltageBlockElement_Struct {
    float	Value_LineVoltage;			//过电流保护线电压闭锁定值：***.**V（输入值范围：0-100V）
    float Value_NegativeVoltage;	//过电流保护负序电压闭锁定值：***.**V（输入值范围：0-100V）
};

struct RelaySetting_OverCurrentRelay_InrushRestrainElement_Struct {
    float Value_Ratio;			//过电流保护涌流抑制比：***.**%
};

struct RelaySetting_OverCurrentRelay_Zone_Struct {
...
struct RelaySetting_OverCurrentRelay_Inv_Struct {
...
struct RelaySetting_OverCurrentRelay_PTBreak_Struct {
...
struct RelaySetting_OverCurrentRelay_Acc_Struct {
...
struct RelaySetting_OverCurrentRelay_Struct {
...
struct RelaySetting_IoRelay_Zone_Struct {
...
struct RelaySetting_IoRelay_Inv_Struct {
...
struct RelaySetting_IoRelay_Acc_Struct {
...
struct RelaySetting_IoRelay_Struct {
...
struct RelaySetting_adaptIoRelay_Struct {
...
struct RelaySetting_BusRelay_Struct {
    uint32_t	Enable;								//母线保护投/退：Yes(1)-投入/No(0)-退出（*使能控制字）
};

struct RelaySetting_ReclosureRelay_Struct {
...
struct RelaySetting_OverLoadRelay_Struct {
...
struct RelaySetting_LowVoltageRelay_Struct {
...
struct RelaySetting_OverVoltageRelay_Struct {
...
struct RelaySetting_LowFrequencyRelay_Struct {
...
struct RelaySetting_HighFrequencyRelay_Struct {
...
struct RelaySetting_InversePowerRelay_Struct {
...
struct RelaySetting_HarmonicCurrentRelay_Struct {
...
struct RelaySetting_HarmonicVoltageRelay_Struct {
...
struct RelaySetting_AbnormalMonitoringElement_BusPTBreak_Struct {
...
struct RelaySetting_AbnormalMonitoringElement_LinePTBreak_Struct {
...
struct RemoteAdjust_Setting_Struct {
    uint16_t Code;
    RelaySetting_Struct Setting;
};

struct AnalogCoeff_Struct {
    float Ua;
    float Ub;
    float Uc;
    float Uo;
...
struct RemoteAdjust_DeviceSetting_Struct {
...
struct RemoteAdjust_PrimarySystem_Struct {
    uint16_t Common_addr;	//Common_Addr_RemoteAdjust
...
struct RemoteAdjust_ControlSetting_Struct {
    uint16_t Common_addr;	//Common_Addr_RemoteAdjust
...
struct RemoteAdjust_SoftStrap_Struct {
    uint16_t Common_addr;	//Common_Addr_RemoteAdjust
    uint16_t Object_addr;	//系统定值遥调地址（自定义）
    uint16_t Length;
...
struct RemoteAdjust_RelaySetting_Struct {
    uint16_t Common_addr;	//Common_Addr_RemoteAdjust
...
struct RemoteAdjust_AnalogQuantity_Struct {
    uint16_t Common_addr;	//Common_Addr_RemoteAdjust
...
struct RemoteAdjust_SettingCode_Struct {
    uint16_t Common_addr;	//Common_Addr_RemoteAdjust
